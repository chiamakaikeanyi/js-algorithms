...
Binary numbers are converted to decimals by successively multiplying each binary digit by increasing powers of 2; 
...
function binaryToDecimal(binary) {
 ...
 let decimal = 0; // initialize decimal to 0
 
 for(let i = 0; i < binaryLength; i++) { // loop through the string to get each bit
